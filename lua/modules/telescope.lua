...
-- mappings
vim.api.nvim_set_keymap("n", "<Leader>ff", [[<Cmd>lua require("telescope.builtin").fd()<CR>]], opt)
vim.api.nvim_set_keymap("n", "<Leader>fwl", [[<Cmd>lua require("telescope.builtin").live_grep()<CR>]], opt)
vim.api.nvim_set_keymap("n", "<Leader>fwd", [[<Cmd>lua require("telescope.builtin").grep_string()<CR>]], opt)
